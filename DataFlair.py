...
class InvoiceGenerator:
    def __init__(self,root):
        ...
        # ====submit details
        Button(self.frame, text = "Submit Details",command = self.generate_invoice, font = ("times new roman", 14),fg = "white",cursor = "hand2", bg = "#B00857").place(x = 50, y = 600, width = 180, height = 40)
