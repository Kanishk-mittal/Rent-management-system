...
def generate_invoice(tenant_name,date,rent,internet_charges,last_unit,current_unit,amount_paid,balance_remaining,last_balance=0):
    global root
    pdf = FPDF()
    ...
    pdf.cell(140, 10, txt="Total", border=1, ln=0, align="L")
    pdf.cell(40, 10, txt=str(total), border=1, ln=0, align="R")

    pdf.cell(140, 10, txt="Amount paid", border=1, ln=0, align="L")
    pdf.cell(40, 10, txt=str(amount_paid), border=1, ln=0, align="R")

    pdf.cell(140, 10, txt="Balance ", border=1, ln=0, align="L")
    pdf.cell(40, 10, txt=str(balance_remaining), border=1, ln=0, align="R")
...
def generate_Bill(tenant_name,date,rent,internet_charges,last_unit,current_unit,last_balance=0,):
    global root
    pdf = FPDF()
    ...
    pdf.output(f"D:\\rent_invoice\\bill{tenant_name}_{date}.pdf")
